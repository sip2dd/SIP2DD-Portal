                                    ...
                                    @if ($list_gov != null)
                                        @foreach ($list_gov as $gov)
                                            @if (strlen($gov['kode_daerah']) < 3)
                                                <option class="l1"
                                                    value="{{ url('/tp2dd') }}?kode_daerah={{ $gov['kode_daerah'] }}">
                                                    {{ $gov['nama_daerah'] }}</option>
                                            @else
                                                <option class="l2"
                                                    value="{{ url('/tp2dd') }}?kode_daerah={{ $gov['kode_daerah'] }}">
                                                    {{ $gov['nama_daerah'] }}</option>
                ...
                @if ($governments != null)
                    <div class="row">
                        @foreach ($governments as $government)
                            <div class="col-xl-4 col-lg-4 col-md-6 add-padd">
                                <div class="services-caption text-center mb-30">
                                    <div class="service-icon">
                                        <span><img src="{{ $government['logo'] }}"
                                                onerror="this.src='{{ URL::asset('img/logo/log.png') }}'"
