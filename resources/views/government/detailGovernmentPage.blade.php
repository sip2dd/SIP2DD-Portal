...
@section('title', 'Detail TP2DD | Portal Percepatan Digitalisasi Daerah')
...
@section('content')
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <input type="hidden" name="id"
                                    value="<?php echo $govDetail != null ? $govDetail['instansi_id'] : ''; ?>" />
    ...
    <!-- Slider Area End-->
    <!--================Berita Area =================-->
    <section class="blog_area section-padd4 add-padd sky-blue">
        <div class="container">
            <!--Berita Terbaru-->
            <div class="row">
                                ...
                                @foreach ($govNewsHighlights as $index => $govNewsHighlight)
                                    <article class="blog_item">
                                        <div class="blog_item_img">
                                            <img class="card-img" src="{{ $govNewsHighlight['gambar_utama'] }}"
                                                onerror="this.src='{{ URL::asset('img/P2DD.png') }}'" alt="">
                                        </div>
                                        <div class="blog_details">
                                            <div class="row">
                                                <div class="col">
                                                    <p>{{ tanggal_indonesia($govNewsHighlight['tanggal_publikasi'], false) }}
                                                    </p>
                                                </div>
                                                <div class="col">
                                                    <div class="lengkapnya_1">
                                                        <a
                                                            href="{!!  url('/detailberita?id=') !!}{{ $govNewsHighlight['berita_id'] }}">Selengkapnya
                    ...
                    <div class="blog_right_sidebar">
                        <div class="row">
                            ...
                            <div class="col">
                                <div class="section-judul-berita2">
                                    @if ($govDetail != null)
                                        <h6><a href="{!!  url('/beritatp2dd?id=') !!}{{ $govDetail['instansi_id'] }}">Lihat
                                                Semua</a></h6>
                                    @endif
                            ...
                            <div class="services-caption text-center mb-10 mr-1 ml-1">
                                ...
                                <div class="service-cap">
                                    ...
                                    <div class="link_layanan">
                                        <a href="{!!  url('layanan?id=') !!}{{ $govService['layanan_id'] }}">Link
                                            Layanan</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="single-customer">
                                    <div class="what-img">
                                        @if ($galleryGovPhoto['link'] != null)
                                            <img class="card-img"
                                                src="http://103.18.117.44/sicantik-ws/webroot/files/upload/{{ $galleryGovPhoto['link'] }}"
                                                onerror="this.src='{{ URL::asset('img/P2DD.png') }}'" alt="">
                                        @else
                                            <img class="card-img"
                                                src="http://103.18.117.44/sicantik-ws/webroot/files/upload/{{ $galleryGovPhoto['file'] }}"
                                                onerror="this.src='{{ URL::asset('img/P2DD.png') }}'" alt="">
                                        @endif
                                    ...
                                    <div class="what-cap">
                                        ...
                                        <h4><a
                                                href="{!!  url('/detailgalerifoto?id=') !!}{{ $galleryGovPhoto['galeri_id'] }}">
                                                {{ Str::limit($galleryGovPhoto['judul'], 60) }}</a></h4>
                                    </div>
                                    <div class="tulisan-lengkapnya">
                                        <a href="{!!  url('/detailgalerifoto?id=') !!}{{ $galleryGovPhoto['galeri_id'] }}">Selengkapnya
