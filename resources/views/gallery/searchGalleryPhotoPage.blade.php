...
@section('title', 'Cari Galeri Foto | Portal Percepatan Digitalisasi Daerah')
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    @if ($galleryPhoto['link'] != null)
                                        <img class="card-img" src="{{ $galleryPhoto['link'] }}"
                                            onerror="this.src='{{ URL::asset('img/P2DD.png') }}'" alt="">
                                    @else
                                        <img class="card-img" src="{{ $galleryPhoto['file'] }}"
                                            onerror="this.src='{{ URL::asset('img/P2DD.png') }}'" alt="">
                                    @endif
                                </div>
                                ...
                                <div class="blog_details">
                                    ...
                                    <a href="{!!  url('/detailgalerifoto?id=') !!}{{ $galleryPhoto['galeri_id'] }}"
                                        class="deskripsi-galeri1">
                                        <h2>{{ Str::limit($galleryPhoto['judul'], 60) }}</h2>
                                    </a>
                                    <div class="row">
                                        <div class="col daftar_berita_link">
                                            <a href="{!!  url('/detailgalerifoto?id=') !!}{{ $galleryPhoto['galeri_id'] }}">Selengkapnya
                ...
                <div class="row justify-content-center mb-30">
                    <nav class="blog-pagination">
                        <ul class="pagination">
                            @if ($page > 1)
                                <li class="page-item">
                                    <a href="{!!  url('/carigalerifoto?keyword=' . $keyword . '&page=' . ($page - 1)) !!}"
                            ...
                            @for ($i = 1; $i <= $pagination; $i++)
                                @if ($page == $i)
                                    <li class="page-item active">
                                        <a href="{!!  url('/carigalerifoto?keyword=' . $keyword . '&page=' . $i) !!}"
                                            class="page-link">{{ $i }}</a>
                                    </li>
                                @else
                                    <li class="page-item">
