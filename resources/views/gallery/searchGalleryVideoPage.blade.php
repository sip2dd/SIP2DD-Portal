...
@section('title', 'Cari Galeri Video | Portal Percepatan Digitalisasi Daerah')
...
@section('content')
    ...
    <!-- Slider Area End-->
    <!--================Galeri=================-->
    <section class="blog_area pt-10 background_3 add-padd">
        <div class="container">
            @if ($keyword != '')
                <div class="row">
                            ...
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    @if ($galleryVideo['tipe'] == 'Youtube')
                                        <img class="card-img"
                                            src="https://img.youtube.com/vi/{{ getYouTubeVideoId($galleryVideo['link']) }}/maxresdefault.jpg"
                                ...
                                <div class="blog_details">
                                    ...
                                    <a href="{!!  url('/detailgalerivideo?id=') !!}{{ $galleryVideo['galeri_id'] }}"
                                    ...
                                    <div class="row">
                                        <div class="col daftar_berita_link">
                                            <a
                                                href="{!!  url('/detailgalerivideo?id=') !!}{{ $galleryVideo['galeri_id'] }}">Selengkapnya
                ...
                <div class="row justify-content-center mb-30">
                    <nav class="blog-pagination">
                        <ul class="pagination">
                            @if ($page > 1)
                                <li class="page-item">
                                    <a href="{!!  url('/carigalerivideo?keyword=' . $keyword . '&page=' . ($page - 1)) !!}"
                            ...
                            @for ($i = 1; $i <= $pagination; $i++)
                                @if ($page == $i)
                                    <li class="page-item active">
                                        <a href="{!!  url('/carigalerivideo?keyword=' . $keyword . '&page=' . $i) !!}"
                                            class="page-link">{{ $i }}</a>
                                    </li>
                                @else
                                    <li class="page-item">
