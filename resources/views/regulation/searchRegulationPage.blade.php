...
@section('title', 'Cari Regulasi | Portal Percepatan Digitalisasi Daerah')
                ...
                <div class="row justify-content-center">
                    <nav class="blog-pagination">
                         <ul class="pagination">
                            @if($page > 1)
                            <li class="page-item">
                                <a href="{!! url('/cariregulasi?nomor='.$nomor.'&tahun='.$tahun.'&tentang='.$tentang.'&status='.$status.'?&page='.($page-1)) !!}" class="page-link" aria-label="Previous">
                            ...
                            @for($i =1; $i<=$pagination; $i++)
                                    ...
                                    <li class="page-item active">
                                        <a href="{!! url('/cariregulasi?nomor='.$nomor.'&tahun='.$tahun.'&tentang='.$tentang.'&status='.$status.'?&page='.$i) !!}" class="page-link">{{$i}}</a>
                                    </li>
                                    @else
                                    <li class="page-item">
                                        <a href="{!! url('/cariregulasi?nomor='.$nomor.'&tahun='.$tahun.'&tentang='.$tentang.'&status='.$status.'?&page='.$i) !!}" class="page-link">{{$i}}</a>
                            ...
                            @else
                            <li class="page-item">
                                <a href="{!! url('/cariregulasi?nomor='.$nomor.'&tahun='.$tahun.'&tentang='.$tentang.'&status='.$status.'?&page='.($page+1)) !!}" class="page-link" aria-label="Next">
                                    <i class="ti-angle-right"></i>
                                </a>
                            </li>
                            @endif
