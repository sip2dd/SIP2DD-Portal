                        ...
                        <div class="col-lg-4 col-md-6 clear-padd">
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img" src="{{ $berita_daerah['gambar_utama'] }}"
                                ...
                                <div class="blog_details">
                                    ...
                                    <a href="{!!  url('/detailberita?id=') !!}{{ $berita_daerah['berita_id'] }}"
                                        class="deskripsi-galeri1">
                                        <h2>{{ Str::limit($berita_daerah['judul'], 60) }}</h2>
                                    </a>
                                    <div class="row">
                                        <div class="col daftar_berita_link">
                                            <a href="{!!  url('/detailberita?id=') !!}{{ $berita_daerah['berita_id'] }}">Selengkapnya
                ...
                <div class="row justify-content-center mb-30">
                    <nav class="blog-pagination">
                        <ul class="pagination">
                            @if ($page > 1)
                                <li class="page-item">
                                    <a href="{!!  url('/beritadaerah?page=' . ($page - 1)) !!}" class="page-link"
                                        aria-label="Previous">
