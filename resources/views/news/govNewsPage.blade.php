                        ...
                        <div class="col-lg-4 col-md-6 clear-padd">
                            <article class="blog_item">
                                <div class="blog_item_img">
                                    <img class="card-img" src="{{ $berita_satgas['gambar_utama'] }}"
                                ...
                                <div class="blog_details">
                                    ...
                                    <h6> <img src="{{ URL::asset('img/logo_list/gov4_grey.svg') }}" alt="logo">
                                        {{ $berita_satgas['dibuat_oleh'] }}
                                    </h6>
                                    <a href="{!!  url('/detailberita?id=') !!}{{ $berita_satgas['berita_id'] }}"
                                        class="deskripsi-galeri1">
                                        <h2>{{ Str::limit($berita_satgas['judul'], 60) }}</h2>
                                    </a>
                                    <div class="row">
                                        <div class="col daftar_berita_link">
                                            <a href="{!!  url('/detailberita?id=') !!}{{ $berita_satgas['berita_id'] }}">Selengkapnya
                ...
                <div class="row justify-content-center mb-30">
                    <nav class="blog-pagination">
                        <ul class="pagination">
                            @if ($page > 1)
                                <li class="page-item">
                                    <a href="{!!  url('/beritasatgas?page=' . ($page - 1)) !!}" class="page-link"
                                        aria-label="Previous">
                            ...
                            @for ($i = 1; $i <= $pagination; $i++)
                                @if ($page == $i)
                                    <li class="page-item active">
                                        <a href="{!!  url('/beritasatgas?page=' . $i) !!}" class="page-link">{{ $i }}</a>
                                    </li>
                                @else
                                    <li class="page-item">
                                        <a href="{!!  url('/beritasatgas?page=' . $i) !!}" class="page-link">{{ $i }}</a>
