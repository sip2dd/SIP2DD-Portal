...
@section('title', 'Pencarian Materi | Portal Percepatan Digitalisasi Daerah')
            ...
            <div class="row justify-content-center mb-50">
                <nav class="blog-pagination">
                    <ul class="pagination">
                        @if($page > 1)
                        <li class="page-item">
                            <a href="{!! url('/carimateri?keyword='.$title.'&page='.($page-1)) !!}" class="page-link" aria-label="Previous">
                        ...
                        @for($i =1; $i<=$pagination; $i++)
                                ...
                                <li class="page-item active">
                                    <a href="{!! url('/carimateri?keyword='.$title.'&page='.$i) !!}" class="page-link">{{$i}}</a>
                                </li>
                                @else
                                <li class="page-item">
                                    <a href="{!! url('/carimateri?keyword='.$title.'&page='.$i) !!}" class="page-link">{{$i}}</a>
                        ...
                        @else
                        <li class="page-item">
                            <a href="{!! url('/carimateri?keyword='.$title.'&page='.($page+1)) !!}" class="page-link" aria-label="Next">
                                <i class="ti-angle-right"></i>
                            </a>
                        </li>
                        @endif
