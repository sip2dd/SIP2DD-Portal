...
@section('title', 'Cari FAQ | Portal Percepatan Digitalisasi Daerah')
        ...
        @if($keyword != "")
            ...
            <div class="row justify-content-center pb-50">
                <nav class="blog-pagination">
                    ...
                    @if($page > 1)
                            <li class="page-item">
                                <a href="{!! url('/carifaq?keyword='.$title.'&page='.($page-1)) !!}" class="page-link" aria-label="Previous">
                            ...
                            @for($i =1; $i<=$pagination; $i++)
                                    ...
                                    <li class="page-item active">
                                        <a href="{!! url('/carifaq?keyword='.$title.'&page='.$i) !!}" class="page-link">{{$i}}</a>
                                    </li>
                                    @else
                                    <li class="page-item">
                                        <a href="{!! url('/carifaq?keyword='.$title.'&page='.$i) !!}" class="page-link">{{$i}}</a>
                            ...
                            @else
                            <li class="page-item">
                                <a href="{!! url('/carifaq?keyword='.$title.'&page='.($page+1)) !!}" class="page-link" aria-label="Next">
                                    <i class="ti-angle-right"></i>
                                </a>
                            </li>
                            @endif
